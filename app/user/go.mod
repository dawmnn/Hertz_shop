...
//replace github.com/chenzhuoyu/iasm => github.com/chenzhuoyu/iasm v0.0.0

//replace github.com/cloudwego/biz-demo/gomall/common => github.com/cloudwego/biz-demo/gomall/common v0.0.0
